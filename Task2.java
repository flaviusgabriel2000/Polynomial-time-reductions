...
public final class Task2 extends Task {
    ...
    /**
     * The transpose of graph g.
     */
    private final Graph transposeG;
    /**
    ...
    public void solve() throws IOException, InterruptedException {
        ...
        while (K > 1) {
            ...
            if (this.decipheredVertices.isEmpty()) {
                K--;
            } else {
                break;
            }
    ...
    public void readProblemData() throws IOException {
        ...
        for (int i = 1; i <= N; i++) {
            if (!g.getMap().containsKey(i)) {
                g.addVertex(i);
                transposeG.addVertex(i);
            }
        }
        for (int i = 1; i <= M; i++) {
            line = input.readLine();
    ...
    public void writeAnswer() {
        if (decipheredVertices.isEmpty()) {
            ...
            // There's a clique of size K in this graph, representing
            // the extended group of people. Now, we take the remaining
            // N - K vertices and that is finally the essential group.
            for (int i = 1; i <= N; i++) {
                if (!decipheredVertices.contains(i)) {
                    System.out.print(i + " ");
                }
            }
            System.out.println();
